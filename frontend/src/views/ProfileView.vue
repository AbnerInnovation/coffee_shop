  ...
  <div class="py-4 sm:py-6">
    <div class="max-w-3xl mx-auto px-3 sm:px-4 lg:px-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        ...
        <!-- Actions - Cloud only (hidden in Electron Desktop) -->
        <div v-if="isWeb()" class="px-4 py-3 sm:px-6 sm:py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
          <button
